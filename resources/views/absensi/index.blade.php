                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('absensi.show', $absensi->id) }}" class="btn btn-sm btn-info">
...
<script>
    $(document).ready(function() {
        ...
        $('.edit-btn').click(function() {
            var id = $(this).data('id');
            var url = "{{ route('absensi.show', ':id') }}".replace(':id', id);

            $.get(url, function(data) {
                $('#editForm').attr('action', "{{ route('absensi.update', ':id') }}".replace(':id', id));
