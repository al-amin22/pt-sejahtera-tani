                ...
                <table class="table table-hover datatable" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <div class="modal fade" id="editModal-{{ $item->id }}" tabindex="-1" aria-labelledby="editModalLabel-{{ $item->id }}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('hasil_produksi.update', $item->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                        ...
                        <div class="modal fade" id="deleteModal-{{ $item->id }}" tabindex="-1" aria-labelledby="deleteModalLabel-{{ $item->id }}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('hasil_produksi.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <div class="modal-header">
...
<div class="modal fade" id="addHasilProduksiModal" tabindex="-1" aria-labelledby="addHasilProduksiModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('hasil_produksi.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="jenis_hasil" class="form-label">Jenis Hasil</label>
